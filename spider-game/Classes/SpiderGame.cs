...
namespace FuncionesCiclos
{
    ...
    public class SpiderGame : ISpiderGame
    {
        ...
        public CoordModel DrawMosquito(CoordModel rangePosition, FrameModel frameSpider, FrameModel frameSpider2)
        {
            ...
            CoordModel mosquitoPosition = new CoordModel(random.Next(rangePosition.X), random.Next(rangePosition.Y));
            //{
        ...
        public CoordModel MoveSpider(ConsoleKey keyMovement, CoordModel spiderPosition1, CoordModel spiderPosition2, FrameModel frameDimension, FrameModel holesWeb, string whatSpider)
        {
            ...
            if (whatSpider == "player1")
            {
                ...
                FrameModel spider1Range = new(spiderPosition1.X, spiderPosition1.Y, spiderPosition1.X + 12, spiderPosition1.Y + 3);
            ...
            else
            {
                ...
                FrameModel spider1Range = new(inicioAlto: spiderPosition2.Y, finalAlto: spiderPosition2.Y + 3,
                inicioAncho: spiderPosition2.X, finalAncho: spiderPosition2.X + 12);
                // };
